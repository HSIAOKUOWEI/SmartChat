...
# 查询对话框标题和对话框ID API
@dialogue_bp.route('/get_dialogues', methods=['GET'])
def get_dialogues():
    try:
...
@dialogue_bp.route('/get_messages/<dialogue_id>', methods=['GET'])
...
# 删除对话框及其相关消息 API
@dialogue_bp.route('/delete_dialogue/<dialogue_id>', methods=['DELETE'])
...
# 更新对话框名称 API
@dialogue_bp.route('/update_title/<dialogue_id>', methods=['POST'])
