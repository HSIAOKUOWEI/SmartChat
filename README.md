...
SmartChat是一款基於Agent思想實現的智能聊天機器人。它能夠根據對話內容自動調用相關工具，包括查詢台灣天氣、網頁問答、圖片問答、圖片生成、檔案問答、搜索引擎問答、查找Arxiv論文、維基百科等功能。透過這些工具的整合，SmartChat可以智能地處理多樣化的用戶需求。具體的實現技術請參考[技術棧](#技術棧)。
...
| **類別**       | **功能**                                                                                       |
|---------------|-------------------------------------------------------------------------------------------------|
| **對話服務**  | - 台灣天氣查詢<br> - 檔案問答<br> - 檔案總結<br> - 圖片對話<br> - 生成圖片<br> - 網頁問答<br> - 搜索引擎對話<br> - Arxiv論文對話<br> - 維基百科對話 |
| **UI功能**    | - 切換LLM模型<br> - 用戶管理（登錄丶註冊丶重置密碼丶登出）<br> - 聊天框管理（新增丶刪除丶改名丶切換）<br> - 文件及圖片上傳 |
